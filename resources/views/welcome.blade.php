...
<div class="wrapper">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <div class="logo-area">
                                <a href="index.html"><img class="img-responsive" src="{{asset('/')}}front-end/assets/img/logo.png" alt="logo"></a>
                            </div>
                        </div>
                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="#">Food Menu</a>
                                            <ul>
                                                <li><a href="food-menu1.html">Food Menu 1</a></li>
                                                <li><a href="food-menu2.html">Food Menu 2</a></li>
                                                <li><a href="food-menu3.html">Food Menu 3</a></li>
                                                <li><a href="food-menu4.html">Food Menu 4</a></li>
                                                <li><a href="food-menu5.html">Food Menu 5</a></li>
                                                <li><a href="food-menu-details.html">Menu Details</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Blog</a>
                                            <ul>
                                        ...
                                        <li><a href="#">Pages</a>
                                            <ul class="mega-menu-area">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="all-chefs.html">All Chefs</a>
                                                </li>
                                                <li>
                                                    <a href="single-chef.html">Single Chef</a>
                                        ...
                                        <ul>
                                                ...
                                                <div class="cart-single-product">
                                                    <div class="media">
                                                        <div class="pull-left cart-product-img">
                                                            <a href="#">
                                                                <img src="{{asset('/')}}front-end/assets/img/dish/1.png" alt="product" class="img-responsive">
                                                            </a>
                                                        </div>
                                            ...
                                            <li>
                                                <div class="cart-single-product">
                                                    <div class="media">
                                                        <div class="pull-left cart-product-img">
                                                            <a href="#">
                                                                <img src="{{asset('/')}}front-end/assets/img/dish/2.png" alt="product" class="img-responsive">
                                                            </a>
                                                        </div>
                                                        <div class="media-body cart-content">
                                                            <ul>
                                            ...
                                            <li>
                                                <ul class="checkout">
                                                    ...
                                                    <li><a href="checkout.html" class="default-btn">Checkout</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
    ...
    <div class="slider1-area">
        <div class="bend niceties preview-1">
            <div id="ensign-nivoslider-3" class="slides">
                <img src="{{asset('/')}}front-end/assets/img/slider/slide1-1.jpg" alt="slider" title="#slider-direction-1"/>
                <img src="{{asset('/')}}front-end/assets/img/slider/slide1-2.jpg" alt="slider" title="#slider-direction-2"/>
                <img src="{{asset('/')}}front-end/assets/img/slider/slide1-3.jpg" alt="slider" title="#slider-direction-3"/>
            </div>
            ...
            <div id="slider-direction-2" class="t-cn slider-direction">
                <div class="slider-content s-tb slide-2">
                    <div class="title-container s-tb-c">
                        <h1 class="title1">Grilled Beef Shawarma</h1>
                        <p>Dorem Ipsum is simply dummy of the printing and typesetting 's standard dummy when.</p>
                        <div class="slider-btn-area">
                            <a href="#" class="ghost-btn">Order Now</a>
                        </div>
    ...
    <div class="about1-area section-space">
        <img class="img-responsive section-back" src="{{asset('/')}}front-end/assets/img/section-back-1.png" alt="Sestion Back">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 wow fadeInLeft">
                    <a href="#"><img class="img-responsive" src="{{asset('/')}}front-end/assets/img/chef/1.png" alt="chef"></a>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12 wow fadeInRight">
                    <div class="about1-area-top">
                        <h2>Red <span> Chili</span></h2>
                        <h2>For Getting Real Taste</h2>
                    </div>
                    <h3 class="title-bar-big-left">Discover Our Food</h3>
                    <p>Morbi ut sapien scelerisque, fermentum ex ultrices, bibendum lacus. Aliquam id consequat ex. Integer luctus tellus at rutrum maximus. Quisque lacinia blandit quam rhoncus vulputate vulputate fermentum.</p>
            ...
            <div class="row">
                <div class="rc-carousel"
                    ...
                    <div class="special-dish-box">
                        <span>$20</span>
                        <a href="#"><img class="img-responsive" src="{{asset('/')}}front-end/assets/img/dish/1.png" alt="dish"></a>
            ...
            <div class="row">
                ...
                <div class="tasty-menu-inner">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h3 class="inner-sub-title-center title-bar-full-width">Lunch Menu</h3>
                        <ul>
                            <li>
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{asset('/')}}front-end/assets/img/dish/2.png" alt="client" class="img-responsive">
                                    </a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h3 class="inner-sub-title-center title-bar-full-width">Dinner Menu</h3>
                        <ul>
                            <li>
                                <div class="media">
                                    <a href="#" class="pull-left">
    ...
    <!-- Recipe of the day Area Start Here -->
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="recipe-of-the-day-content">
                                <div class="recipe-of-the-day-content-inner">
                                    <h2 class="title-recipe">Soft Chicken Kabab</h2>
                                    <p class="recipe-of-the-day-content-details">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.A wonderful serenity has taken possession of my entire soul, like these sweet mornings.</p>
                                    <ul class="time-needs">
                                        <li>
                                    ...
                                    <div class="awards-box">
                                        <ul>
                                            <li>
                                                ...
                                                <span>Serving:<span class="about-counter" data-num="20">20</span></span>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>
                                                <span>Happy Customer:<span class="about-counter" data-num="150">150</span></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="recipe-of-the-day-content">
                                <div class="recipe-of-the-day-img">
                                    <a href="#"><img class="img-responsive" src="{{asset('/')}}front-end/assets/img/recipe-of-the-day-banner.jpg" alt="recipe-of-the-day"></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Recipe of the day Area End Here -->
    <!-- Table Reservation 1 Area Start Here -->
    <div class="table-reservation1-area">
        <div class="container">
            <h2 class="title">Book A Table</h2>
            <span class="subtitle-color">Reserved Your Table</span>
            <h3>Opening Hour 8:00 AM - 10:00 PM Every day on week.</h3>
            <div class="row">
    ...
    <!-- Table Reservation 1 Area End Here -->
        ...
        <div class="container">
            ...
            <div class="rc-carousel"
                ...
                <div class="expert-chefs-box">
                    <a href="#"><img class="img-responsive" src="{{asset('/')}}front-end/assets/img/team/1.jpg" alt="team"></a>
                ...
                <div class="expert-chefs-box">
                    <a href="#"><img class="img-responsive" src="{{asset('/')}}front-end/assets/img/team/2.jpg" alt="team"></a>
                    <div class="expert-chefs-box-content">
                        <span></span>
                ...
                <div class="expert-chefs-box">
                    <a href="#"><img class="img-responsive" src="{{asset('/')}}front-end/assets/img/team/3.jpg" alt="team"></a>
                    <div class="expert-chefs-box-content">
                        <span></span>
            ...
            <div class="row products-container">
                <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                    <div class="client-reviews-left">
                        <img class="img-responsive" src="{{asset('/')}}front-end/assets/img/client/left-back.jpg" alt="client">
                    </div>
                </div>
                        ...
                        <div class="rc-carousel"
                            ...
                            <ul>
                                <li>
                                    <div class="media">
                                        <a href="#" class="pull-left">
                                            <img src="{{asset('/')}}front-end/assets/img/client/1.png" alt="client" class="img-responsive">
                                        </a>
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="media">
                                        <a href="#" class="pull-left">
                                            <img src="{{asset('/')}}front-end/assets/img/client/2.png" alt="client" class="img-responsive">
                                        </a>
                                        <div class="media-body">
                                            <h3><a href="#">Daina Rose</a></h3>
                                            <p>Atetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="media">
                                        <a href="#" class="pull-left">
                                            <img src="{{asset('/')}}front-end/assets/img/client/3.png" alt="client" class="img-responsive">
                                        </a>
                                        <div class="media-body">
                                            <h3><a href="#">Daina Rose</a></h3>
                                            <p>Atetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <div class="container">
            <div class="rc-carousel"
                ...
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/1.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/2.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/3.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/4.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/5.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/6.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/7.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/8.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/9.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/10.png" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{asset('/')}}front-end/assets/img/brand/1.png" alt="brand"></a>
                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="footer-box">
                            ...
                            <div class="footer-blog-post">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{asset('/')}}front-end/assets/img/footer-blog1.jpg" alt="footer-blog" class="img-responsive">
                                    </a>
                                    <div class="media-body">
                            ...
                            <div class="footer-blog-post">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{asset('/')}}front-end/assets/img/footer-blog2.jpg" alt="footer-blog" class="img-responsive">
                                    </a>
                                    <div class="media-body">
                                        <h4><a href="#">Beef Burger Daily Special Foods That</a></h4>
                                        <p>20 Aug, 2016</p>
                            ...
                            <div class="footer-blog-post">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{asset('/')}}front-end/assets/img/footer-blog3.jpg" alt="footer-blog" class="img-responsive">
                                    </a>
                                    <div class="media-body">
                                        <h4><a href="#">Beef Burger Daily Special Foods That</a></h4>
                                        <p>20 Aug, 2016</p>
