...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <a href="{{route('aboutus.index')}}" class="btn btn-success">View All slider</a>
                <div class="row">
                    <div class="col-md-10">
                        <form class="form-horizontal" method="post" action="{{route('aboutus.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{$errors->has('email') ? 'has-error' : ''}}">
                                <label class="col-md-2 control-label"> Web site Email</label>
                                <div class="col-md-10">
                                    <input type="text" name="email" class="form-control" placeholder="Enter site E-mail">
                            ...
                            <div class="form-group {{$errors->has('address') ? 'has-error' : ''}}">
                                ...
                                <div class="col-md-10">
                                    <textarea  cols="5" rows="5" name="address"  class=" form-control" ></textarea>
